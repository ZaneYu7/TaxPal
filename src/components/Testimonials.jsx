        ...
        >
          {
            testimonials.map((testimonialGroup, testimonialGroupIndex) => (
              <li key={testimonialGroupIndex}>
                <ul
                  role="list"
                  className="flex flex-col gap-6 sm:gap-y-8"
                >
                  {
                    testimonialGroup.map((testimonial, testimonialIndex) => (
                      <li key={testimonialIndex}>
                        <figure
                          className="relative p-6 overflow-hidden bg-white shadow-xl rounded-2xl shadow-slate-900/10"
                        >
                          <QuoteIcon
                          ...
                          <figcaption
                            className='relative flex items-center justify-between pt-6 mt-6 border-t border-slate-100'
                          >
                            <div>
                              <div
                                className="text-base font-display text-slate-900"
                              >
